...
combinacion.modelos.minimo <- function (x = tabla.AUC.ordenadas, cant.modelos = 10, minSp = 0.98) { #funcion donde x es el resultado de la funcion del script de curvas ROC.R y cant.modelos es la cant de modelos que quiero combinar
...
resultados.ensemble.minimo <- combinacion.modelos.minimo(x = tabla.AUC.ordenadas, cant.modelos = 10, minSp = 0.98)
