...
clasificaciones.test.set.lm <- function (test.set = "Dtest.xlsx", lista.de.modelos = lista.modelos){
        ...
        lista.porcentaje.bien.clasificados <- lapply(lista.bien.clasificados, function (x) 100*sum(x, na.rm = TRUE)/length(x)) #porcentaje de buenas clasificaciones en el test set
