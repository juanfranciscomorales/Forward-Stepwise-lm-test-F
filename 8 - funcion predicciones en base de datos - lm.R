...
clasificaciones.base.datos.lm <- function (base.datos = "Dtest.xlsx", lista.de.modelos = lista.modelos){
...
tabla.predicciones.base.datos <- clasificaciones.base.datos.lm(base.datos = "Dtest.xlsx", lista.de.modelos = lista.modelos)
