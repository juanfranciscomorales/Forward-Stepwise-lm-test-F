optimizacion.punto.corte.ROC.test.set.max.especificidad <- function (test.set = "BASE SIMULADA - Poliaminas.csv" , modelos = lista.modelos) { #funcion que busca el punto de corte optimo donde la especificidad es maxima
