...
for ( i in 1:length(lista.sweatlead)) {
        ...
        lista.base.datos[[i]] <- clasificaciones.base.datos.ensemble.promedio.lm(base.datos  = lista.sweatlead[i],cant.modelos = 5, x = tabla.AUC.ordenadas.dude, remover.NA = TRUE)  
}
