...
clasificaciones.test.set.ensemble.minimo.lm <- function (test.set = "Dtest.csv",cant.modelos = 10, x = tabla.AUC.ordenadas, remover.NA = FALSE){
...
clasificaciones.test.set.ensemble.minimo.lm(test.set = "Dtest.csv",cant.modelos = 10, x = tabla.AUC.ordenadas, remover.NA = FALSE)

clasificaciones.test.set.ensemble.minimo.lm(test.set = "Dtest.csv",cant.modelos = 10, x = tabla.AUC.ordenadas.test.set, remover.NA = FALSE)

clasificaciones.test.set.ensemble.minimo.lm(test.set = "Dtest.csv",cant.modelos = 10, x = tabla.sensibilidad.ordenadas, remover.NA = FALSE)

clasificaciones.test.set.ensemble.minimo.lm(test.set = "Dtest.csv",cant.modelos = 10, x = tabla.AUC.ordenadas.dude, remover.NA = FALSE)

clasificaciones.test.set.ensemble.minimo.lm(test.set = "Dtest.csv",cant.modelos = 10, x = tabla.porcentajes.buenas.clasificaciones.k.fold.CV.lm, remover.NA = FALSE)

clasificaciones.test.set.ensemble.minimo.lm(test.set = "Dtest.csv",cant.modelos = 10, x = tabla.AUROC.k.fold.CV.lm, remover.NA = FALSE)
