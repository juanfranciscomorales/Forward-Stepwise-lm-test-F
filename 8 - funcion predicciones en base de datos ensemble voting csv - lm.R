...
clasificaciones.base.datos.ensemble.voting.lm <- function (base.datos = "Dtest.csv",cant.modelos = 10,fraccion.votos = 0.5, x = tabla.AUC.ordenadas.glm){
...
tabla.predicciones.base.datos <- clasificaciones.base.datos.ensemble.voting.lm(base.datos  = "Dtest.csv",cant.modelos = 10,fraccion.votos = 0.5, x = tabla.AUC.ordenadas) ## si quiero que sea por AUC

tabla.predicciones.base.datos <- clasificaciones.base.datos.ensemble.voting.lm(base.datos  = "Dtest.csv",cant.modelos = 10,fraccion.votos = 0.5, x = tabla.sensibilidad.ordenadas) ## si quiero que sea por modelos con mayor sensibilidad
