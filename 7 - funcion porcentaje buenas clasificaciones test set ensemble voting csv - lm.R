...
clasificaciones.test.set.ensemble.voting.lm <- function (test.set = "Dtest.csv",cant.modelos = 10, fraccion.votos = 0.5,  x = tabla.sensibilidad.ordenadas){
...
clasificaciones.test.set.ensemble.voting.lm(test.set = "Dtest.csv",cant.modelos = 10,fraccion.votos = 0.5, x = tabla.sensibilidad.ordenadas)

clasificaciones.test.set.ensemble.voting.lm(test.set = "Dtest.csv",cant.modelos = 10,fraccion.votos = 0.5, x = tabla.AUC.ordenadas) 