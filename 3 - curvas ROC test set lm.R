...
AUC.curvas.ROC.test.set.lm <- function ( test.set= "TEST SET - Poliaminas.xlsx", modelos = lista.modelos ) {
...
tabla.AUC.ordenadas.test.set <- AUC.curvas.ROC.test.set.lm( test.set= "TEST SET - Poliaminas.xlsx", modelos = lista.modelos) # aplico mi funcion a la lista de modelos armada con la funcion anterior, como resultado obtengo una tabla con los valores de AUC ordenadas por mejores modelos
